...
const services = [
  {
    ...
    description: "Сказки, которые придумал народ и передавал из поколения в поколение: «Колобок», «Репка», «Теремок», «Курочка Ряба».",
    icon: (
  ...
  },
  {
    ...
    description: "Сказки, написанные конкретными писателями: Пушкин, Чуковский, Маршак, Андерсен. У каждой есть автор.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
        <path
          strokeLinecap="round"
  ...
  {
    title: "Писатели-сказочники",
    description: "Александр Пушкин, Корней Чуковский, Самуил Маршак, Ганс Христиан Андерсен — великие авторы детских сказок.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
        <path
          strokeLinecap="round"
  ...
  {
    title: "Игра «Народная или авторская?»",
    description: "Педагог показывает картинку или называет сказку, а дети определяют её вид. Весело, познавательно и интерактивно!",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
        <path
          strokeLinecap="round"
