...
const steps = [
  {
    ...
    title: "Знакомимся",
    description:
      "Рассматриваем книги со сказками. Педагог спрашивает: «Какие сказки вы знаете? Кто их придумал?» Дети делятся своими знаниями.",
  },
  {
    number: "02",
    title: "Открываем",
    description:
      "Узнаём, что сказки бывают народными и авторскими. Педагог показывает примеры и портреты писателей-сказочников.",
  },
  {
    number: "03",
    title: "Играем",
    description:
      "Игра «Народная или авторская?». Педагог показывает картинки и называет сказки — дети определяют их вид.",
  },
  {
    number: "04",
    title: "Запоминаем",
    description:
      "Закрепляем знания: вспоминаем имена писателей, называем любимые сказки и рассказываем, почему они нравятся.",
  },
]
        ...
        <div className="grid lg:grid-cols-12 gap-16 lg:gap-24">
          ...
          <div className="lg:col-span-4">
            <div className="lg:sticky lg:top-32">
              ...
              >
                Путь
                <span className="italic"> в сказку</span>
              </h2>
              <p
              ...
              >
                Каждое занятие — маленькое путешествие. Шаг за шагом дети открывают мир сказок,
                учатся думать, сравнивать и удивляться.
              </p>
            </div>
          </div>
