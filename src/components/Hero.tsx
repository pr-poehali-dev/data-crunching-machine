  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 lg:px-12 pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          Удивительный
          <span className="block text-sage">мир сказок</span>
        </h1>
        ...
        >
          Откроем тайну сказок вместе: что такое народные и авторские сказки, кто их придумал и как научиться их различать.
        </p>
