      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div>
            ...
            >
              Напишите педагогу — расскажите о своём ребёнке или задайте вопрос по программе занятия.
            </p>
            ...
            >
              ...
              <div>
                ...
                <p className="text-foreground">Подготовительная группа, 6–7 лет</p>
              </div>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Ваш вопрос о занятии..."
                  required
                />
              </div>
              <button
